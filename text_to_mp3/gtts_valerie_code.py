...
""" the code is has explanations and tells what is going on
...
"""This in intended to be the pience of code you manipulate and edit
 You could also start from a fresh file or include it as part of a bigger
 program. As long as you import the modules you are reffering to
 it is like everything is in the same program"""

import os
#import gtts_am as gtt 

os.environ["GOOGLE_APPLICATION_CREDENTIALS"] = "/Users/alexmoura/Downloads/ornate-shape-217301-705704bfee84.json"


#list of voices. Just uncoment it an run it.
#gtts_am.list_voices() # see that here I decided to use the name of the module. You can use either



#Here the program call the synthesize_from_excel function from the gtts_am model from its alias
# file path inside the function should be all you need to change
